...
- [技术博客/技术组织](https://github.com/nieweidong/fetool#blogs)
- [技术公众号](https://github.com/nieweidong/fetool#gongzhonghao)
- [博客搭建](https://github.com/nieweidong/fetool#blog_build)
- [HTML](https://github.com/nieweidong/fetool#html)
- [CSS](https://github.com/nieweidong/fetool#css)
- [浏览端 JS](https://github.com/nieweidong/fetool#javascript)
- [Project Build](https://github.com/nieweidong/fetool#project_build)
- [Node Package](https://github.com/nieweidong/fetool#node_package)
- [Node Project](https://github.com/nieweidong/fetool#node_project)
- 精选阅读
  - [前端技术](https://github.com/nieweidong/fetool#fedev)
  - [Node 学习资料](https://github.com/nieweidong/fetool#node_read)
  - [前端面试](https://github.com/nieweidong/fetool#interview)
  - [其他技术](https://github.com/nieweidong/fetool#otherdev)
- 工具/软件
  - [Web](https://github.com/nieweidong/fetool#web)
  - [APP](https://github.com/nieweidong/fetool#app)
  - [Mac 软件篇](https://github.com/nieweidong/fetool#mac_soft)
  - [Linux](https://github.com/nieweidong/fetool#linux)
- [Chrome Plugins](https://github.com/nieweidong/fetool#BrowserPlugins)
- [Git](https://github.com/nieweidong/fetool#git)
- [服务端](https://github.com/nieweidong/fetool#servers)
- [数据端](https://github.com/nieweidong/fetool#backend)
- [客户端](https://github.com/nieweidong/fetool#client)
- [设计/交互](https://github.com/nieweidong/fetool#ux)
- [速查手册](https://github.com/nieweidong/fetool#handbook)
- [杂七杂八](https://github.com/nieweidong/fetool#other)
- [前端炫技-炫酷狂拽叼炸天的 Web](https://github.com/nieweidong/fetool#cool)
- [小结](https://github.com/nieweidong/fetool#summary)
- [TODO](https://github.com/nieweidong/fetool#todo)
...
- [CSSgram](https://github.com/una/CSSgram) - 图片滤镜库，终于可以用 CSS 在 web 上实现滤镜的效果鸟 IE不支持，不过新的移动设备支持没问题 [Can I Use](http://caniuse.com/#search=CSS Blend Modes)
...
- [Push.js](https://github.com/Nickersoft/push.js) - 基于 `Notification API` 实现的桌面效果的提示栏。浏览器支持情况不错，如http://caniuse.com/#search=Notification
...
- [MongoDB 极简实践入门](https://github.com/StevenSLXie/Tutorials-for-Web-Developers/blob/master/MongoDB 极简实践入门.md) - 入门推荐的套路，非常浅显易懂
...
- [二维码生成器](https://chrome.google.com/webstore/detail/二维码qr码生成器/pflgjjogbmmcmfhfcnlohagkablhbpmg) - RT。PS：这FF早已经自带生成二维码工具了，`Chrome` 还得装插件才行，任性...
- [WEB前端助手(FeHelper)](https://chrome.google.com/webstore/detail/web前端助手fehelper/pkgccpejnmalmdinmhkkfafefagiiiad) - [百度FE](https://www.baidufe.com/)出品，功能超全的 Chrome 插件。简单列一下其功能：QR码生成器、字符串编解码工具、JSON格式化查看器、前端编码规范检测、代码压缩工具、页面取色工具、统计并分析网页加载性能等等
...
- [Git 速查](https://github.com/flyhigher139/Git-Cheat-Sheet/blob/master/Git Cheat Sheet-Zh.md) - 分类清晰的速查表
...
俺算个比较能自我总结的码农，所以偶尔喜欢写点东西做些记录或者自我熏陶陶醉一下。 可写着写着发现`Evernote`里面的东西太尼玛多(乱)了，于是想着把一些技术相关的资料都整理整理，都丢到`Github`上沉淀下来。 这样Evernote就可以只需要记录些偏生活方便的，看着清爽一些...
